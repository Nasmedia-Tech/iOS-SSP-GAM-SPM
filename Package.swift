...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-SSP-GAM-SPM/releases/download/1.0.10/AdMixerMediationGAM1.0.10.xcframework.zip",
            checksum: "a97ba689870d6e1f469d0d577ad0ba5fbd5efdf1f126f0eea9efb2cb3a5fa846"
        ),
        .target(
