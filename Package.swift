...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-SSP-GAM-SPM/releases/download/1.2.7/AdMixerMediationGAM1.2.7.xcframework.zip",
            checksum: "1868184069ca8f1e167d8b2c46bb92ace04534e3a57abd3fc0e9bda3fcb40d9c"
        ),
        .target(
