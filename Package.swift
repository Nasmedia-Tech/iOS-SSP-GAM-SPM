...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-AdMixerDownload/raw/main/AdMixerMediationGAM1.0.6.xcframework.zip",
            checksum: "29f218daf52ec1e20ed881b2aeef14e2d02c981cc85bbea9d4ecb6d514f04515"
        ),
        .target(
