...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-SSP-GAM-SPM/releases/download/1.2.6/AdMixerMediationGAM1.2.6.xcframework.zip",
            checksum: "7e75f053697d2e5173ac8638386befd239a644a127bdf94d51066df0cf346ea9"
        ),
        .target(
