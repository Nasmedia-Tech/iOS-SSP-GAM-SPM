...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-SSP-GAM-SPM/releases/download/1.0.9/AdMixerMediationGAM1.0.9.xcframework.zip",
            checksum: "50daf17b6cabc001c03063f3f3227f2705b69042f9b19d26f6f4063a0e1fb7fe"
        ),
        .target(
