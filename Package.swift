...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-SSP-GAM-SPM/releases/download/1.2.0/AdMixerMediationGAM1.2.0.xcframework.zip",
            checksum: "595ab0723ceacb5161033989be5ff9cb1e64ead8935a011a57ab6abb9cb75d9d"
        ),
        .target(
